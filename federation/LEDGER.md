...
| | |
| --- | --- |
| Units and participants | 0 |
| Points issued | 0 |
| Active points (quorum denominator) | 0 |
| Assemblies held | 0 |
...
No unit is recorded and no points have been issued. The first assembly that accepts a record and a delivery writes the first row.
